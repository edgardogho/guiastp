...
\resizebox{!}{5cm} {
	...
	\item Teniendo en cuenta los últimos circuitos diseñe un multiplicador por sumas sucesivas. Ej: Si se desea multiplicar 3x4 se realiza 3+3+3+3. Va a utilizar un acumulador para la suma sucesivas y otro que decrementa hasta cero y controla los valores de realimentación. \textit{Nota: la idea del ejercicio es utilizar lo visto de secuenciales y combinacionales para resolver este problema más complejo. Haga las modificaciones que crea necesarias para resolver el problema. Recomendamos seguir con otros ejercicios y volver a este luego de completar la guía. }
